...
- In order to make the tight relationship between the parent and possible children of compound components explicit, the possible children components are often added as static properties of the parent component.
