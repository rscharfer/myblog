...
[The example using React 16](https://codesandbox.io/p/sandbox/blog-state-reducer-pattern-eyrsc) is pretty much this pattern would look like using React 19, but the React 19 version would probably use TypeScript in lieu of `actionTypes` variable for type safety. 
